...
ARCHITECTURE structure OF MemoryBlocks IS
...
SIGNAL \ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTADATAIN_bus\ : std_logic_vector(19 DOWNTO 0);
SIGNAL \ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTAADDR_bus\ : std_logic_vector(4 DOWNTO 0);
SIGNAL \ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTADATAOUT_bus\ : std_logic_vector(19 DOWNTO 0);
...
SIGNAL \ram_instance|altsyncram_component|auto_generated|q_a\ : std_logic_vector(3 DOWNTO 0);
...
\ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTADATAIN_bus\ <= (gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & gnd & \dataIn[3]~input_o\ & \dataIn[2]~input_o\ & \dataIn[1]~input_o\ & 
\dataIn[0]~input_o\);

\ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTAADDR_bus\ <= (\address[4]~input_o\ & \address[3]~input_o\ & \address[2]~input_o\ & \address[1]~input_o\ & \address[0]~input_o\);

\ram_instance|altsyncram_component|auto_generated|q_a\(0) <= \ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTADATAOUT_bus\(0);
\ram_instance|altsyncram_component|auto_generated|q_a\(1) <= \ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTADATAOUT_bus\(1);
\ram_instance|altsyncram_component|auto_generated|q_a\(2) <= \ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTADATAOUT_bus\(2);
\ram_instance|altsyncram_component|auto_generated|q_a\(3) <= \ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTADATAOUT_bus\(3);
...
\ram_instance|altsyncram_component|auto_generated|ram_block1a0\ : cyclonev_ram_block
-- pragma translate_off
GENERIC MAP (
	data_interleave_offset_in_bits => 1,
	data_interleave_width_in_bits => 1,
	logical_ram_name => "ram32x4:ram_instance|altsyncram:altsyncram_component|altsyncram_hvv3:auto_generated|ALTSYNCRAM",
...
PORT MAP (
	...
	portadatain => \ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTADATAIN_bus\,
	portaaddr => \ram_instance|altsyncram_component|auto_generated|ram_block1a0_PORTAADDR_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
